...
const NewsletterSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    window.location.href = "tel:+18883608685";
  };
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
              ...
              <form onSubmit={handleSubmit} className="flex gap-3">
                <Input
                  ...
                  className="flex-1 bg-white border-none rounded-full px-6 py-6 text-foreground pointer-events-none"
                />
                <Button
                  type="submit"
                  className="bg-dark-green text-white hover:bg-dark-green/90 rounded-full px-8 py-6 font-semibold pointer-events-none"
                >
                  SUBSCRIBE
                </Button>
              </form>
