...
const TestimonialsSection = () => {
  const testimonial = {
    text: "I wasn't sure which Radio XN kit would fit my vehicle, but the team at 1800 XM Rradio helped me pick the right one. It arrived fast, installed easily, and works like a charm. Great service!",
    author: "SARAH D.",
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <Button className="bg-lime text-white hover:bg-lime-dark rounded-full px-8 py-6 font-semibold">
